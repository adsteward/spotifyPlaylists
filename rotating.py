...
short_term_id = "3eUoKZ4hzqmZ9DygX8mZIO"
medium_term_id = "5bDPSOnOGAW2a2XwA0z0U5"
all_time_id = "7s61z0AmtwBHtpZPl01Dcz"
...
def top_tracks_complete(time_frame, playlist_id):
    '''
    ...
    top_tracks = helper_functions.get_top_tracks(time_frame)
    split_list = helper_functions.split_track_list(50, top_tracks)
    print("length of pslit list: ", len(split_list))
    ...
    helper_functions.add_list_of_tracklists_to_playlist(split_list, playlist_id, True)
...
user_input = input("Would you like to update your short-term playlist? y/n \n")
if user_input == "y" or user_input == "Y" :
    helper_functions.clear_playlist(short_term_id)
    top_tracks_complete("short_term", short_term_id)
print("done")

user_input = input("Would you like to update your medium-term playlist? y/n \n")
if user_input == "y" or user_input == "Y" :
    helper_functions.clear_playlist(medium_term_id)
    top_tracks_complete("medium_term", medium_term_id)
print("done")

user_input = input("Would you like to update your all-time playlist? y/n \n")
if user_input == "y" or user_input == "Y" :
    helper_functions.clear_playlist(all_time_id)
    top_tracks_complete("long_term", all_time_id)
print("done")